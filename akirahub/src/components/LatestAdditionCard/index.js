  ...
  return (
    <div className="bg-white rounded-md shadow-sm overflow-hidden flex flex-col">
      ...
      <div className="flex border-t border-gray-200">
        <button
          className="flex-1 flex items-center justify-center py-2 text-xs font-medium text-gray-600 hover:bg-gray-50 transition"
        ...
        <button
          className={`flex-1 flex items-center justify-center py-2 text-xs font-medium transition ${
            isFavorite
